...
describe Grade, '#has_active_grade_classes_in?' do
  ...
  it 'should return true if having active school classes in the given school year' do
    expect(grades(:first_grade).has_active_grade_classes_in? @fake_school_year).to be_true
  end

  it 'should return false if having no active school classes in the given school year' do
    @fake_school_year.id = 2
    expect(grades(:first_grade).has_active_grade_classes_in? @fake_school_year).to be_false
  end

  it 'should return false if having no school classes in the grade' do
    expect(grades(:third_grade).has_active_grade_classes_in? @fake_school_year).to be_false
  end
end
...
describe Grade, '#below_first_grade?' do
  ...
  it 'should return true for PreK' do
    expect(grades(:pre_grade).below_first_grade?).to be_true
  end

  it 'should return true for K' do
    expect(grades(:k_grade).below_first_grade?).to be_true
  end

  it 'should return false for 1st grade or above' do
    expect(grades(:first_grade).below_first_grade?).to be_false
    expect(grades(:second_grade).below_first_grade?).to be_false
    expect(grades(:third_grade).below_first_grade?).to be_false
  end
end

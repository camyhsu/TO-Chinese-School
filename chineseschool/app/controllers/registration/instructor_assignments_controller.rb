class Registration::InstructorAssignmentsController < ApplicationController
  ...
  def destroy
    instructor_assignment = InstructorAssignment.find params[:id].to_i
  ...
  def select_school_class
    ...
    @instructor_assignment.school_class = SchoolClass.find params[:selected_class_id]
    unless @instructor_assignment.save

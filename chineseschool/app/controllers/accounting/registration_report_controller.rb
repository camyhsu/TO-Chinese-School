...
SUM(student_fee_payments.elective_class_fee_in_cents) as elective_class_fee_total, 
...
EOSQL
  ...
  def charges_collected_report
    ...
    @charges_collected[:elective_class_fee_in_cents] = tuition_query_result[0]['elective_class_fee_total'].to_i

class SchoolYear < ActiveRecord::Base
  ...
  TRACK_EVENT_DATE = Date.parse('2016-03-19')
  TRACK_EVENT_SIGN_UP_PREVIEW_START_DATE = Date.parse('2016-01-23')
  TRACK_EVENT_SIGN_UP_START_DATE = Date.parse('2016-02-06')
  TRACK_EVENT_SIGN_UP_END_DATE = Date.parse('2016-03-06')

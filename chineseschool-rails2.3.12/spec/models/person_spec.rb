...
describe Person, 'creating student class assignment based on registration preference' do
  fixtures :people, :grades, :student_class_assignments, :registration_preferences, :school_classes, :student_status_flags
  ...
  it 'should not create student class assignment if registration is already completed' do
    student_status_flags(:status_six).registration_completed = true
    student_status_flags(:status_six).save!
  ...
  it 'should create a new student class assignment based on registration preference if none exists' do
    ...
    student_status_flags(:status_six).registered?.should be_false
    ...
    people(:person_six).student_status_flag_for(SchoolYear.current_school_year).registered?.should be_true
  end
  ...
  it 'should update existing student class assignment based on registration preference' do
    ...
    student_status_flags(:preference_one).registered?.should be_false
    ...
    student_class_assignment.elective_class.should == school_classes(:chinese_history_two)
    people(:person_one).student_status_flag_for(SchoolYear.current_school_year).registered?.should be_true
  end
end
